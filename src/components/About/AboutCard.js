      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Adarsh Tiwari </span>
            from <span className="purple"> Ahmedabad, India.</span>
            <br />I am a junior pursuing B.Tech in Information Technology in IIIT
            Gwalior.
            <br />
            <br />
          ...
          <ul>
            ...
            <li className="about-activity">
              <i className="far fa-hand-point-right"></i> Trading
            </li>
            <li className="about-activity">
